...
var parse = require("react-docgen-typescript").withCustomConfig(
...
var paths = {
  examples: path.join("examples"), // Examples are stored as a subdirectory in the component
...
function getComponentData(paths, componentName) {
  ...
  var content = readFile(path.join(componentPath));
  var infos = parse(componentPath);
  return infos.map(info => ({
    ...
    examples: getExampleData(
      path.join(paths.components, componentName, paths.examples),
      componentName
    )
  }));
}
